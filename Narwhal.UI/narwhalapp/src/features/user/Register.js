...
function Register(){
    ...
    const submitForm = (e) =>{
        ...
        if(registerObj.password.trim() === "")return setErrorMessage("Password is required! (use any value)")
            ...
            registerModel.Username = registerObj.name
            registerModel.Email = registerObj.emailId
            registerModel.Password = registerObj.password
                ...
                <div className='py-24 px-10'>
                    ...
                    <form onSubmit={(e) => submitForm(e)}>
                        ...
                        <div className="mb-4">
                            ...
                            <InputText defaultValue={registerObj.name} updateType="name" containerStyle="mt-4" labelTitle="Username" updateFormValue={updateFormValue}/>

...
//nodecss klasörü içindeki css2i import ettik
import './glow.css';
  ...
  return (
    <div style={{
      ...
      <div style={{ 
        ...
        <span style={{ fontSize: 14, fontWeight: '500' }}>Docker Config</span>
        <img 
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', paddingTop: '15px' }}>
            <div style={{ 
              ...
              />
              <span style={{ color: '#495057', fontSize: '13px', marginLeft: '8px' }}>Data</span>
            </div>

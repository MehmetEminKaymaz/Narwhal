  ...
  return (
    <div style={{
      ...
      <div style={{ 
        ...
        <span style={{ fontSize: 14, fontWeight: '500' }}>Docker Registry Image</span>
        <img 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', paddingTop: '15px' }}>
            ...
            <div style={{ 
              ...
              <Handle
                ...
                isConnectable={isConnectable}
              />
              <span style={{ color: '#495057', fontSize: '13px', marginLeft: '8px' }}>From</span>
            </div>
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', paddingTop: '15px' }}>
            ...
            <div style={{ 
              ...
              <span style={{ color: '#495057', fontSize: '13px', marginRight: '8px' }}>SHA256 Digest</span>
              <Handle
                id="sha256DigestHandle"
                type="source"
                position={Position.Right}
                style={{ 
                  background: '#dc3545',

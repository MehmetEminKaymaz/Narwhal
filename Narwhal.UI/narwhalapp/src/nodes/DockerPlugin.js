  ...
  return (
    <div style={{
      ...
      <div style={{ 
        ...
        <span style={{ fontSize: 14, fontWeight: '500' }}>Docker Plugin</span>
        <img 
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', paddingTop: '15px' }}>
            ...
            <div style={{ 
              ...
              <span style={{ color: '#495057', fontSize: '13px', marginRight: '8px' }}>Plugin Reference</span>
              <Handle
                id="pluginReferenceHandle"
                type="source"
                position={Position.Right}
                style={{ 
                  background: '#dc3545',

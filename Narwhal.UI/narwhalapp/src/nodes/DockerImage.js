  ...
  return (
    <div style={{
      ...
      <div style={{ 
        ...
        <span style={{ fontSize: 14, fontWeight: '500' }}>Docker Image</span>
        <img 
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', paddingTop: '15px' }}>
            ...
            <div style={{ 
              ...
              <span style={{ color: '#495057', fontSize: '13px', marginRight: '8px' }}>Image Id</span>
              <Handle
                id="imageIdHandle"
                type="source"
                position={Position.Right}
            ...
            <div style={{ 
              ...
              <span style={{ color: '#495057', fontSize: '13px', marginRight: '8px' }}>Repo Digest</span>
              <Handle
                id="repoDigestHandle"
                type="source"
                position={Position.Right}
            ...
            <div style={{ 
              ...
              <span style={{ color: '#495057', fontSize: '13px', marginRight: '8px' }}>Use Registry</span>
              <Handle
                id="registryHandle"
                type="source"
                position={Position.Right}

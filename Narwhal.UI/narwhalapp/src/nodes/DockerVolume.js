  ...
  return (
    <div style={{
      ...
      <div style={{ 
        ...
        <span style={{ fontSize: 14, fontWeight: '500' }}>Docker Volume</span>
        <img 
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', paddingTop: '15px' }}>
            <div style={{ 
              ...
              />
              <span style={{ color: '#495057', fontSize: '13px', marginLeft: '8px' }}>Driver</span>
            </div>
            ...
            <div style={{ 
              ...
              <Handle
                ...
                isConnectable={isConnectable}
              />
              <span style={{ color: '#495057', fontSize: '13px', marginLeft: '8px' }}>Driver Opts</span>
            </div>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', paddingTop: '15px' }}>
            ...
            <div style={{ 
              ...
              <span style={{ color: '#495057', fontSize: '13px', marginRight: '8px' }}>Mount Point</span>
              <Handle
                id="mountpointHandle"
                type="source"
                position={Position.Right}
